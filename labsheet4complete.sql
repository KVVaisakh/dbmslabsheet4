...
insert into employee(employee_id,ename,date_of_birth,salary)
...
/*12*/
select to_char(date_of_birth,'dd/mm/yyyy') from employee;
/*13*/
select to_date('20170103','YYYYMMDD');
/*14*/
select to_date('2017 Feb 20','YYYY Mon DD');
/*15*/
select * from employee where to_char(date_of_birth,'month')='september';
